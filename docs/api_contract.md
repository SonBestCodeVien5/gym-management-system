...
| Method | Endpoint | Code làm gì | Trạng thái |
|---|---|---|---|
| POST | /api/v1/subscriptions | Tạo thẻ tập mới ở trạng thái `pending`. | Implemented |
...
| Method | Endpoint | Code làm gì | Trạng thái |
|---|---|---|---|
| POST | /api/v1/courses | Tạo gói tập mẫu với giá và số buổi. | Implemented |
...
| PATCH | /api/v1/courses/:id | Cập nhật thông tin gói tập. | Implemented |
