...
> Ghi chú đối chiếu hiện trạng: tài liệu này mô tả kiến trúc mục tiêu để đưa vào báo cáo. Backend
> hiện tại đã triển khai Go + Gin + MongoDB theo cấu trúc `cmd/server`, `internal/handlers`,
> `internal/service`, `internal/repository`, `internal/models`. Redis, Nginx, CI/CD, frontend,
> cron worker và một số thư viện đề xuất bên dưới là định hướng/future work, chưa có trong repo
> hiện tại. Xem thêm [07_current_implementation_evidence.md](07_current_implementation_evidence.md).
